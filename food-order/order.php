        ...
        <div class="container">
            ...
            <fieldset style="width:500px; height:150px;background-color:#ffcc66">
                ...
                <fieldset style="width:500px; height:550px;background-color:#ffcc66">
                    ...
                    <input type="text" name="full-name" placeholder="E.g. Pawan Joshi" onkeypress="return (event.charCode > 64 && event.charCode < 91) || (event.charCode > 96 && event.charCode < 123) || (event.charCode==32)" class="input-responsive" required>
